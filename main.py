...
if __name__ == "__main__":
    ...
    input_coord_system = "gcj02"  # 'wgs84','cgcs2000','gcj02'
    input_coords = [
    ...
    # input_coords = [
    #     [112.944414312283, 28.1863812651092],
    #     [112.945000374953, 28.1864496614391],
    #     [112.945147896449, 28.1856476809437],
    #     [112.944662416617, 28.1856061067039],
    # ]  # 输入坐标 TDT
    ...
    output_path = r"output/waypoints-gd.kmz"  # 输出文件路径
    output_coord_system = "wgs84"  # 'wgs84','cgcs2000','gcj02'
    ...
    print(f"{waypoint_coords_wgs84[0]=}")
